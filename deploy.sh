...
aws cloudfront create-invalidation --distribution-id E2151ROOTNL7JP --paths /public/assets/javascripts/app-modules-min.js /public/assets/javascripts/libs-min.js /public/assets/stylesheets/app-styles.css /app/search/views/search.html